...
// Test RSAEncryption.GenerateKeyPair(block#291092) covers block 291092
// Extracting the test for RSAEncryption.GenerateKeyPair(block#291092) from the counterexample...
method {:test} test0() {
var r0, r1 := RSAEncryption.GenerateKeyPair((2147475928 as RSAEncryption.StrengthBits));
}
// Procedure Impl$$RSAEncryption.__default.GenerateKeyPair (1 blocks) is completely covered by 1 (failed to extract 0) tests generated using 1 SMT queries (failed 0 queries)

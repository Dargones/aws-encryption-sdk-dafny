...
module srcSDKSerializeHeaderAuthdfyUnitTests {
import HeaderAuth
import Seq
import Wrappers
import Math
...
// Test HeaderAuth.WriteHeaderAuthTagV2(block#2216578) covers block 2216578
// Extracting the test for HeaderAuth.WriteHeaderAuthTagV2(block#2216578) from the counterexample...
method {:test} test0() {
...
expect d2.AESMac?, "Test does not meet type constraints and should be removed";
var r0 := HeaderAuth.WriteHeaderAuthTagV2(d2);
}
// Test HeaderAuth.WriteHeaderAuthTagV1(block#2218200) covers block 2218200
// Extracting the test for HeaderAuth.WriteHeaderAuthTagV1(block#2218200) from the counterexample...
method {:test} test1() {
var d0 : seq<StandardLibrary.UInt.uint8> := [];
var d1 : seq<StandardLibrary.UInt.uint8> := [];
var d2 : HeaderAuth.AESMac := HeaderTypes.HeaderAuth.AESMac(headerIv:=d0,headerAuthTag:=d1);
...
// Test HeaderAuth.WriteHeaderAuthTag(block#2220932) covers block 2220927
// Test HeaderAuth.WriteHeaderAuthTag(block#2220932) covers block 2220928
// Test HeaderAuth.WriteHeaderAuthTag(block#2220932) covers block 2220932
// Extracting the test for HeaderAuth.WriteHeaderAuthTag(block#2220932) from the counterexample...
method {:test} test2() {
...
// Test HeaderAuth.WriteHeaderAuthTag(block#2220931) covers block 2220927
// Test HeaderAuth.WriteHeaderAuthTag(block#2220931) covers block 2220929
// Test HeaderAuth.WriteHeaderAuthTag(block#2220931) covers block 2220931
// Extracting the test for HeaderAuth.WriteHeaderAuthTag(block#2220931) from the counterexample...
method {:test} test3() {
var d0 : seq<StandardLibrary.UInt.uint8> := [];
var d1 : seq<StandardLibrary.UInt.uint8> := [];
var d2 : HeaderAuth.AESMac := HeaderTypes.HeaderAuth.AESMac(headerIv:=d0,headerAuthTag:=d1);
...
expect (true && d6.HKDF? ==> d6.hmac.SHA_512? && d6.saltLength == 32 && d6.inputKeyLength == 32 && d6.outputKeyLength == 32) && !d6.IDENTITY?, "Test does not meet type constraints and should be removed";
var d7 : MaterialProviders.AlgorithmSuites.SignatureAlgorithm := MaterialProviders.AlgorithmSuites.SignatureAlgorithm.None;
var d8 : MaterialProviders.AlgorithmSuites.AlgorithmSuite := MaterialProviders.AlgorithmSuites.AlgorithmSuiteInfo.AlgorithmSuiteInfo(messageVersion:=60,id:=d3,encrypt:=d4,kdf:=d5,commitment:=d6,signature:=d7);
expect (d8.kdf.HKDF? ==> d8.kdf.outputKeyLength == d8.encrypt.keyLength) && (d8.signature.ECDSA? ==> d8.kdf.HKDF?) && (d8.commitment.HKDF? ==> d8.commitment.saltLength == 32 && d8.commitment == d8.kdf) && (d8.kdf.HKDF? && d8.commitment.None? ==> d8.kdf.saltLength == 0) && (d8.id == Aws.Crypto.AlgorithmSuiteId.ALG_AES_128_GCM_IV12_TAG16_NO_KDF ==> d8.messageVersion == 1 && d8.encrypt.keyLength == 16 && d8.kdf.IDENTITY? && d8.signature.None? && d8.commitment.None?) && (d8.id == Aws.Crypto.AlgorithmSuiteId.ALG_AES_192_GCM_IV12_TAG16_NO_KDF ==> d8.messageVersion == 1 && d8.encrypt.keyLength == 24 && d8.kdf.IDENTITY? && d8.signature.None? && d8.commitment.None?) && (d8.id == Aws.Crypto.AlgorithmSuiteId.ALG_AES_256_GCM_IV12_TAG16_NO_KDF ==> d8.messageVersion == 1 && d8.encrypt.keyLength == 32 && d8.kdf.IDENTITY? && d8.signature.None? && d8.commitment.None?) && (d8.id == Aws.Crypto.AlgorithmSuiteId.ALG_AES_128_GCM_IV12_TAG16_HKDF_SHA256 ==> d8.messageVersion == 1 && d8.encrypt.keyLength == 16 && d8.kdf.HKDF? && d8.kdf.hmac == HMAC.Digests.SHA_256 && d8.signature.None? && d8.commitment.None?) && (d8.id == Aws.Crypto.AlgorithmSuiteId.ALG_AES_192_GCM_IV12_TAG16_HKDF_SHA256 ==> d8.messageVersion == 1 && d8.encrypt.keyLength == 24 && d8.kdf.HKDF? && d8.kdf.hmac == HMAC.Digests.SHA_256 && d8.signature.None? && d8.commitment.None?) && (d8.id == Aws.Crypto.AlgorithmSuiteId.ALG_AES_256_GCM_IV12_TAG16_HKDF_SHA256 ==> d8.messageVersion == 1 && d8.encrypt.keyLength == 32 && d8.kdf.HKDF? && d8.kdf.hmac == HMAC.Digests.SHA_256 && d8.signature.None? && d8.commitment.None?) && (d8.id == Aws.Crypto.AlgorithmSuiteId.ALG_AES_128_GCM_IV12_TAG16_HKDF_SHA256_ECDSA_P256 ==> d8.messageVersion == 1 && d8.encrypt.keyLength == 16 && d8.kdf.HKDF? && d8.kdf.hmac == HMAC.Digests.SHA_256 && d8.signature.ECDSA? && d8.signature.curve == Signature.ECDSAParams.ECDSA_P256 && d8.commitment.None?) && (d8.id == Aws.Crypto.AlgorithmSuiteId.ALG_AES_192_GCM_IV12_TAG16_HKDF_SHA384_ECDSA_P384 ==> d8.messageVersion == 1 && d8.encrypt.keyLength == 24 && d8.kdf.HKDF? && d8.kdf.hmac == HMAC.Digests.SHA_384 && d8.signature.ECDSA? && d8.signature.curve == Signature.ECDSAParams.ECDSA_P384 && d8.commitment.None?) && (d8.id == Aws.Crypto.AlgorithmSuiteId.ALG_AES_256_GCM_IV12_TAG16_HKDF_SHA384_ECDSA_P384 ==> d8.messageVersion == 1 && d8.encrypt.keyLength == 32 && d8.kdf.HKDF? && d8.kdf.hmac == HMAC.Digests.SHA_384 && d8.signature.ECDSA? && d8.signature.curve == Signature.ECDSAParams.ECDSA_P384 && d8.commitment.None?) && (d8.id == Aws.Crypto.AlgorithmSuiteId.ALG_AES_256_GCM_HKDF_SHA512_COMMIT_KEY ==> d8.messageVersion == 2 && d8.encrypt.keyLength == 32 && d8.kdf.HKDF? && d8.kdf.hmac == HMAC.Digests.SHA_512 && d8.signature.None? && d8.commitment.HKDF?) && (d8.id == Aws.Crypto.AlgorithmSuiteId.ALG_AES_256_GCM_HKDF_SHA512_COMMIT_KEY_ECDSA_P384 ==> d8.messageVersion == 2 && d8.encrypt.keyLength == 32 && d8.kdf.HKDF? && d8.kdf.hmac == HMAC.Digests.SHA_512 && d8.signature.ECDSA? && d8.signature.curve == Signature.ECDSAParams.ECDSA_P384 && d8.commitment.HKDF?), "Test does not meet type constraints and should be removed";
var r0 := HeaderAuth.WriteHeaderAuthTag(d2, d8);
}
// Test HeaderAuth.WriteHeaderAuthTag(block#2220930) covers block 2220927
// Test HeaderAuth.WriteHeaderAuthTag(block#2220930) covers block 2220929
// Test HeaderAuth.WriteHeaderAuthTag(block#2220930) covers block 2220930
// Extracting the test for HeaderAuth.WriteHeaderAuthTag(block#2220930) from the counterexample...
method {:test} test4() {
var d0 : seq<StandardLibrary.UInt.uint8> := [];
var d1 : seq<StandardLibrary.UInt.uint8> := [(0 as StandardLibrary.UInt.uint8)];
var d2 : HeaderAuth.AESMac := HeaderTypes.HeaderAuth.AESMac(headerIv:=d0,headerAuthTag:=d1);
...
// Test HeaderAuth.ReadHeaderAuthTagV1(block#2227731) covers block 2227726
// Test HeaderAuth.ReadHeaderAuthTagV1(block#2227731) covers block 2227727
// Test HeaderAuth.ReadHeaderAuthTagV1(block#2227731) covers block 2227731
// Extracting the test for HeaderAuth.ReadHeaderAuthTagV1(block#2227731) from the counterexample...
method {:test} test5() {
var d0 : seq<StandardLibrary.UInt.uint8> := [(0 as StandardLibrary.UInt.uint8)];
var d1 : SerializeFunctions.ReadableBuffer := SerializeFunctions.ReadableBuffer.ReadableBuffer(bytes:=d0,start:=(1142 as nat));
...
var d7 : MaterialProviders.AlgorithmSuites.AlgorithmSuite := MaterialProviders.AlgorithmSuites.AlgorithmSuiteInfo.AlgorithmSuiteInfo(messageVersion:=63,id:=d2,encrypt:=d3,kdf:=d4,commitment:=d5,signature:=d6);
...
// Test HeaderAuth.ReadHeaderAuthTagV1(block#2227730) covers block 2227726
// Test HeaderAuth.ReadHeaderAuthTagV1(block#2227730) covers block 2227728
// Test HeaderAuth.ReadHeaderAuthTagV1(block#2227730) covers block 2227730
// Extracting the test for HeaderAuth.ReadHeaderAuthTagV1(block#2227730) from the counterexample...
method {:test} test6() {
var d0 : seq<StandardLibrary.UInt.uint8> := [(0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8)];
...
// Test HeaderAuth.ReadHeaderAuthTagV1(block#2227729) covers block 2227726
// Test HeaderAuth.ReadHeaderAuthTagV1(block#2227729) covers block 2227728
// Test HeaderAuth.ReadHeaderAuthTagV1(block#2227729) covers block 2227729
// Extracting the test for HeaderAuth.ReadHeaderAuthTagV1(block#2227729) from the counterexample...
method {:test} test7() {
var d0 : seq<StandardLibrary.UInt.uint8> := [(0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8)];
...
expect (true && d5.HKDF? ==> d5.hmac.SHA_512? && d5.saltLength == 32 && d5.inputKeyLength == 32 && d5.outputKeyLength == 32) && !d5.IDENTITY?, "Test does not meet type constraints and should be removed";
var d6 : MaterialProviders.AlgorithmSuites.SignatureAlgorithm := MaterialProviders.AlgorithmSuites.SignatureAlgorithm.None;
var d7 : MaterialProviders.AlgorithmSuites.AlgorithmSuite := MaterialProviders.AlgorithmSuites.AlgorithmSuiteInfo.AlgorithmSuiteInfo(messageVersion:=68,id:=d2,encrypt:=d3,kdf:=d4,commitment:=d5,signature:=d6);
expect (d7.kdf.HKDF? ==> d7.kdf.outputKeyLength == d7.encrypt.keyLength) && (d7.signature.ECDSA? ==> d7.kdf.HKDF?) && (d7.commitment.HKDF? ==> d7.commitment.saltLength == 32 && d7.commitment == d7.kdf) && (d7.kdf.HKDF? && d7.commitment.None? ==> d7.kdf.saltLength == 0) && (d7.id == Aws.Crypto.AlgorithmSuiteId.ALG_AES_128_GCM_IV12_TAG16_NO_KDF ==> d7.messageVersion == 1 && d7.encrypt.keyLength == 16 && d7.kdf.IDENTITY? && d7.signature.None? && d7.commitment.None?) && (d7.id == Aws.Crypto.AlgorithmSuiteId.ALG_AES_192_GCM_IV12_TAG16_NO_KDF ==> d7.messageVersion == 1 && d7.encrypt.keyLength == 24 && d7.kdf.IDENTITY? && d7.signature.None? && d7.commitment.None?) && (d7.id == Aws.Crypto.AlgorithmSuiteId.ALG_AES_256_GCM_IV12_TAG16_NO_KDF ==> d7.messageVersion == 1 && d7.encrypt.keyLength == 32 && d7.kdf.IDENTITY? && d7.signature.None? && d7.commitment.None?) && (d7.id == Aws.Crypto.AlgorithmSuiteId.ALG_AES_128_GCM_IV12_TAG16_HKDF_SHA256 ==> d7.messageVersion == 1 && d7.encrypt.keyLength == 16 && d7.kdf.HKDF? && d7.kdf.hmac == HMAC.Digests.SHA_256 && d7.signature.None? && d7.commitment.None?) && (d7.id == Aws.Crypto.AlgorithmSuiteId.ALG_AES_192_GCM_IV12_TAG16_HKDF_SHA256 ==> d7.messageVersion == 1 && d7.encrypt.keyLength == 24 && d7.kdf.HKDF? && d7.kdf.hmac == HMAC.Digests.SHA_256 && d7.signature.None? && d7.commitment.None?) && (d7.id == Aws.Crypto.AlgorithmSuiteId.ALG_AES_256_GCM_IV12_TAG16_HKDF_SHA256 ==> d7.messageVersion == 1 && d7.encrypt.keyLength == 32 && d7.kdf.HKDF? && d7.kdf.hmac == HMAC.Digests.SHA_256 && d7.signature.None? && d7.commitment.None?) && (d7.id == Aws.Crypto.AlgorithmSuiteId.ALG_AES_128_GCM_IV12_TAG16_HKDF_SHA256_ECDSA_P256 ==> d7.messageVersion == 1 && d7.encrypt.keyLength == 16 && d7.kdf.HKDF? && d7.kdf.hmac == HMAC.Digests.SHA_256 && d7.signature.ECDSA? && d7.signature.curve == Signature.ECDSAParams.ECDSA_P256 && d7.commitment.None?) && (d7.id == Aws.Crypto.AlgorithmSuiteId.ALG_AES_192_GCM_IV12_TAG16_HKDF_SHA384_ECDSA_P384 ==> d7.messageVersion == 1 && d7.encrypt.keyLength == 24 && d7.kdf.HKDF? && d7.kdf.hmac == HMAC.Digests.SHA_384 && d7.signature.ECDSA? && d7.signature.curve == Signature.ECDSAParams.ECDSA_P384 && d7.commitment.None?) && (d7.id == Aws.Crypto.AlgorithmSuiteId.ALG_AES_256_GCM_IV12_TAG16_HKDF_SHA384_ECDSA_P384 ==> d7.messageVersion == 1 && d7.encrypt.keyLength == 32 && d7.kdf.HKDF? && d7.kdf.hmac == HMAC.Digests.SHA_384 && d7.signature.ECDSA? && d7.signature.curve == Signature.ECDSAParams.ECDSA_P384 && d7.commitment.None?) && (d7.id == Aws.Crypto.AlgorithmSuiteId.ALG_AES_256_GCM_HKDF_SHA512_COMMIT_KEY ==> d7.messageVersion == 2 && d7.encrypt.keyLength == 32 && d7.kdf.HKDF? && d7.kdf.hmac == HMAC.Digests.SHA_512 && d7.signature.None? && d7.commitment.HKDF?) && (d7.id == Aws.Crypto.AlgorithmSuiteId.ALG_AES_256_GCM_HKDF_SHA512_COMMIT_KEY_ECDSA_P384 ==> d7.messageVersion == 2 && d7.encrypt.keyLength == 32 && d7.kdf.HKDF? && d7.kdf.hmac == HMAC.Digests.SHA_512 && d7.signature.ECDSA? && d7.signature.curve == Signature.ECDSAParams.ECDSA_P384 && d7.commitment.HKDF?), "Test does not meet type constraints and should be removed";
var r0 := HeaderAuth.ReadHeaderAuthTagV1(d1, d7);
expect r0.Success? ==> |r0.value.data.headerIv| == d7.encrypt.ivLength as nat && |r0.value.data.headerAuthTag| == d7.encrypt.tagLength as nat;
}
// Test HeaderAuth.ReadHeaderAuthTagV2(block#2233776) covers block 2233767
// Test HeaderAuth.ReadHeaderAuthTagV2(block#2233776) covers block 2233773
// Test HeaderAuth.ReadHeaderAuthTagV2(block#2233776) covers block 2233774
// Test HeaderAuth.ReadHeaderAuthTagV2(block#2233776) covers block 2233776
// Extracting the test for HeaderAuth.ReadHeaderAuthTagV2(block#2233776) from the counterexample...
method {:test} test8() {
var d0 : seq<StandardLibrary.UInt.uint8> := [(0 as StandardLibrary.UInt.uint8)];
...
expect (true && d5.HKDF? ==> d5.hmac.SHA_512? && d5.saltLength == 32 && d5.inputKeyLength == 32 && d5.outputKeyLength == 32) && !d5.IDENTITY?, "Test does not meet type constraints and should be removed";
var d6 : MaterialProviders.AlgorithmSuites.SignatureAlgorithm := MaterialProviders.AlgorithmSuites.SignatureAlgorithm.None;
var d7 : MaterialProviders.AlgorithmSuites.AlgorithmSuite := MaterialProviders.AlgorithmSuites.AlgorithmSuiteInfo.AlgorithmSuiteInfo(messageVersion:=64,id:=d2,encrypt:=d3,kdf:=d4,commitment:=d5,signature:=d6);
expect (d7.kdf.HKDF? ==> d7.kdf.outputKeyLength == d7.encrypt.keyLength) && (d7.signature.ECDSA? ==> d7.kdf.HKDF?) && (d7.commitment.HKDF? ==> d7.commitment.saltLength == 32 && d7.commitment == d7.kdf) && (d7.kdf.HKDF? && d7.commitment.None? ==> d7.kdf.saltLength == 0) && (d7.id == Aws.Crypto.AlgorithmSuiteId.ALG_AES_128_GCM_IV12_TAG16_NO_KDF ==> d7.messageVersion == 1 && d7.encrypt.keyLength == 16 && d7.kdf.IDENTITY? && d7.signature.None? && d7.commitment.None?) && (d7.id == Aws.Crypto.AlgorithmSuiteId.ALG_AES_192_GCM_IV12_TAG16_NO_KDF ==> d7.messageVersion == 1 && d7.encrypt.keyLength == 24 && d7.kdf.IDENTITY? && d7.signature.None? && d7.commitment.None?) && (d7.id == Aws.Crypto.AlgorithmSuiteId.ALG_AES_256_GCM_IV12_TAG16_NO_KDF ==> d7.messageVersion == 1 && d7.encrypt.keyLength == 32 && d7.kdf.IDENTITY? && d7.signature.None? && d7.commitment.None?) && (d7.id == Aws.Crypto.AlgorithmSuiteId.ALG_AES_128_GCM_IV12_TAG16_HKDF_SHA256 ==> d7.messageVersion == 1 && d7.encrypt.keyLength == 16 && d7.kdf.HKDF? && d7.kdf.hmac == HMAC.Digests.SHA_256 && d7.signature.None? && d7.commitment.None?) && (d7.id == Aws.Crypto.AlgorithmSuiteId.ALG_AES_192_GCM_IV12_TAG16_HKDF_SHA256 ==> d7.messageVersion == 1 && d7.encrypt.keyLength == 24 && d7.kdf.HKDF? && d7.kdf.hmac == HMAC.Digests.SHA_256 && d7.signature.None? && d7.commitment.None?) && (d7.id == Aws.Crypto.AlgorithmSuiteId.ALG_AES_256_GCM_IV12_TAG16_HKDF_SHA256 ==> d7.messageVersion == 1 && d7.encrypt.keyLength == 32 && d7.kdf.HKDF? && d7.kdf.hmac == HMAC.Digests.SHA_256 && d7.signature.None? && d7.commitment.None?) && (d7.id == Aws.Crypto.AlgorithmSuiteId.ALG_AES_128_GCM_IV12_TAG16_HKDF_SHA256_ECDSA_P256 ==> d7.messageVersion == 1 && d7.encrypt.keyLength == 16 && d7.kdf.HKDF? && d7.kdf.hmac == HMAC.Digests.SHA_256 && d7.signature.ECDSA? && d7.signature.curve == Signature.ECDSAParams.ECDSA_P256 && d7.commitment.None?) && (d7.id == Aws.Crypto.AlgorithmSuiteId.ALG_AES_192_GCM_IV12_TAG16_HKDF_SHA384_ECDSA_P384 ==> d7.messageVersion == 1 && d7.encrypt.keyLength == 24 && d7.kdf.HKDF? && d7.kdf.hmac == HMAC.Digests.SHA_384 && d7.signature.ECDSA? && d7.signature.curve == Signature.ECDSAParams.ECDSA_P384 && d7.commitment.None?) && (d7.id == Aws.Crypto.AlgorithmSuiteId.ALG_AES_256_GCM_IV12_TAG16_HKDF_SHA384_ECDSA_P384 ==> d7.messageVersion == 1 && d7.encrypt.keyLength == 32 && d7.kdf.HKDF? && d7.kdf.hmac == HMAC.Digests.SHA_384 && d7.signature.ECDSA? && d7.signature.curve == Signature.ECDSAParams.ECDSA_P384 && d7.commitment.None?) && (d7.id == Aws.Crypto.AlgorithmSuiteId.ALG_AES_256_GCM_HKDF_SHA512_COMMIT_KEY ==> d7.messageVersion == 2 && d7.encrypt.keyLength == 32 && d7.kdf.HKDF? && d7.kdf.hmac == HMAC.Digests.SHA_512 && d7.signature.None? && d7.commitment.HKDF?) && (d7.id == Aws.Crypto.AlgorithmSuiteId.ALG_AES_256_GCM_HKDF_SHA512_COMMIT_KEY_ECDSA_P384 ==> d7.messageVersion == 2 && d7.encrypt.keyLength == 32 && d7.kdf.HKDF? && d7.kdf.hmac == HMAC.Digests.SHA_512 && d7.signature.ECDSA? && d7.signature.curve == Signature.ECDSAParams.ECDSA_P384 && d7.commitment.HKDF?), "Test does not meet type constraints and should be removed";
var r0 := HeaderAuth.ReadHeaderAuthTagV2(d1, d7);
expect r0.Success? ==> |r0.value.data.headerIv| == d7.encrypt.ivLength as nat && |r0.value.data.headerAuthTag| == d7.encrypt.tagLength as nat;
}
// Test HeaderAuth.ReadHeaderAuthTagV2(block#2233775) covers block 2233767
// Test HeaderAuth.ReadHeaderAuthTagV2(block#2233775) covers block 2233773
// Test HeaderAuth.ReadHeaderAuthTagV2(block#2233775) covers block 2233775
// Extracting the test for HeaderAuth.ReadHeaderAuthTagV2(block#2233775) from the counterexample...
method {:test} test9() {
var d0 : seq<StandardLibrary.UInt.uint8> := [(0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8)];
var d1 : SerializeFunctions.ReadableBuffer := SerializeFunctions.ReadableBuffer.ReadableBuffer(bytes:=d0,start:=(21 as nat));
var d2 : Aws.Crypto.AlgorithmSuiteId := Crypto.AlgorithmSuiteId.ALG_AES_128_GCM_IV12_TAG16_NO_KDF;
var d3 : AESEncryption.AES_GCM := AESEncryption.AES_GCM.AES_GCM(keyLength:=(32 as AESEncryption.KeyLength),tagLength:=(16 as AESEncryption.TagLength),ivLength:=(12 as AESEncryption.IVLength));
var d4 : MaterialProviders.AlgorithmSuites.KeyDerivationAlgorithm := MaterialProviders.AlgorithmSuites.DerivationAlgorithm.IDENTITY;
expect (true && d4.HKDF? ==> d4.inputKeyLength == d4.outputKeyLength && (d4.hmac == HMAC.Digests.SHA_512 ==> d4.inputKeyLength == 32)) && !d4.None?, "Test does not meet type constraints and should be removed";
...
expect (true && d5.HKDF? ==> d5.hmac.SHA_512? && d5.saltLength == 32 && d5.inputKeyLength == 32 && d5.outputKeyLength == 32) && !d5.IDENTITY?, "Test does not meet type constraints and should be removed";
var d6 : MaterialProviders.AlgorithmSuites.SignatureAlgorithm := MaterialProviders.AlgorithmSuites.SignatureAlgorithm.None;
var d7 : MaterialProviders.AlgorithmSuites.AlgorithmSuite := MaterialProviders.AlgorithmSuites.AlgorithmSuiteInfo.AlgorithmSuiteInfo(messageVersion:=65,id:=d2,encrypt:=d3,kdf:=d4,commitment:=d5,signature:=d6);
expect (d7.kdf.HKDF? ==> d7.kdf.outputKeyLength == d7.encrypt.keyLength) && (d7.signature.ECDSA? ==> d7.kdf.HKDF?) && (d7.commitment.HKDF? ==> d7.commitment.saltLength == 32 && d7.commitment == d7.kdf) && (d7.kdf.HKDF? && d7.commitment.None? ==> d7.kdf.saltLength == 0) && (d7.id == Aws.Crypto.AlgorithmSuiteId.ALG_AES_128_GCM_IV12_TAG16_NO_KDF ==> d7.messageVersion == 1 && d7.encrypt.keyLength == 16 && d7.kdf.IDENTITY? && d7.signature.None? && d7.commitment.None?) && (d7.id == Aws.Crypto.AlgorithmSuiteId.ALG_AES_192_GCM_IV12_TAG16_NO_KDF ==> d7.messageVersion == 1 && d7.encrypt.keyLength == 24 && d7.kdf.IDENTITY? && d7.signature.None? && d7.commitment.None?) && (d7.id == Aws.Crypto.AlgorithmSuiteId.ALG_AES_256_GCM_IV12_TAG16_NO_KDF ==> d7.messageVersion == 1 && d7.encrypt.keyLength == 32 && d7.kdf.IDENTITY? && d7.signature.None? && d7.commitment.None?) && (d7.id == Aws.Crypto.AlgorithmSuiteId.ALG_AES_128_GCM_IV12_TAG16_HKDF_SHA256 ==> d7.messageVersion == 1 && d7.encrypt.keyLength == 16 && d7.kdf.HKDF? && d7.kdf.hmac == HMAC.Digests.SHA_256 && d7.signature.None? && d7.commitment.None?) && (d7.id == Aws.Crypto.AlgorithmSuiteId.ALG_AES_192_GCM_IV12_TAG16_HKDF_SHA256 ==> d7.messageVersion == 1 && d7.encrypt.keyLength == 24 && d7.kdf.HKDF? && d7.kdf.hmac == HMAC.Digests.SHA_256 && d7.signature.None? && d7.commitment.None?) && (d7.id == Aws.Crypto.AlgorithmSuiteId.ALG_AES_256_GCM_IV12_TAG16_HKDF_SHA256 ==> d7.messageVersion == 1 && d7.encrypt.keyLength == 32 && d7.kdf.HKDF? && d7.kdf.hmac == HMAC.Digests.SHA_256 && d7.signature.None? && d7.commitment.None?) && (d7.id == Aws.Crypto.AlgorithmSuiteId.ALG_AES_128_GCM_IV12_TAG16_HKDF_SHA256_ECDSA_P256 ==> d7.messageVersion == 1 && d7.encrypt.keyLength == 16 && d7.kdf.HKDF? && d7.kdf.hmac == HMAC.Digests.SHA_256 && d7.signature.ECDSA? && d7.signature.curve == Signature.ECDSAParams.ECDSA_P256 && d7.commitment.None?) && (d7.id == Aws.Crypto.AlgorithmSuiteId.ALG_AES_192_GCM_IV12_TAG16_HKDF_SHA384_ECDSA_P384 ==> d7.messageVersion == 1 && d7.encrypt.keyLength == 24 && d7.kdf.HKDF? && d7.kdf.hmac == HMAC.Digests.SHA_384 && d7.signature.ECDSA? && d7.signature.curve == Signature.ECDSAParams.ECDSA_P384 && d7.commitment.None?) && (d7.id == Aws.Crypto.AlgorithmSuiteId.ALG_AES_256_GCM_IV12_TAG16_HKDF_SHA384_ECDSA_P384 ==> d7.messageVersion == 1 && d7.encrypt.keyLength == 32 && d7.kdf.HKDF? && d7.kdf.hmac == HMAC.Digests.SHA_384 && d7.signature.ECDSA? && d7.signature.curve == Signature.ECDSAParams.ECDSA_P384 && d7.commitment.None?) && (d7.id == Aws.Crypto.AlgorithmSuiteId.ALG_AES_256_GCM_HKDF_SHA512_COMMIT_KEY ==> d7.messageVersion == 2 && d7.encrypt.keyLength == 32 && d7.kdf.HKDF? && d7.kdf.hmac == HMAC.Digests.SHA_512 && d7.signature.None? && d7.commitment.HKDF?) && (d7.id == Aws.Crypto.AlgorithmSuiteId.ALG_AES_256_GCM_HKDF_SHA512_COMMIT_KEY_ECDSA_P384 ==> d7.messageVersion == 2 && d7.encrypt.keyLength == 32 && d7.kdf.HKDF? && d7.kdf.hmac == HMAC.Digests.SHA_512 && d7.signature.ECDSA? && d7.signature.curve == Signature.ECDSAParams.ECDSA_P384 && d7.commitment.HKDF?), "Test does not meet type constraints and should be removed";
var r0 := HeaderAuth.ReadHeaderAuthTagV2(d1, d7);
expect r0.Success? ==> |r0.value.data.headerIv| == d7.encrypt.ivLength as nat && |r0.value.data.headerAuthTag| == d7.encrypt.tagLength as nat;
}
// No test can be generated for HeaderAuth.ReadHeaderAuthTagV2(block#2233771) because the verifier suceeded.
// No test can be generated for HeaderAuth.ReadHeaderAuthTagV2(block#2233770) because the verifier suceeded.
// Test HeaderAuth.ReadHeaderAuthTagV2(block#2233769) covers block 2233767
// Test HeaderAuth.ReadHeaderAuthTagV2(block#2233769) covers block 2233768
// Test HeaderAuth.ReadHeaderAuthTagV2(block#2233769) covers block 2233769
// Extracting the test for HeaderAuth.ReadHeaderAuthTagV2(block#2233769) from the counterexample...
method {:test} test10() {
var d0 : seq<StandardLibrary.UInt.uint8> := [];
var d1 : SerializeFunctions.ReadableBuffer := SerializeFunctions.ReadableBuffer.ReadableBuffer(bytes:=d0,start:=(1236 as nat));
var d2 : Aws.Crypto.AlgorithmSuiteId := Crypto.AlgorithmSuiteId.ALG_AES_128_GCM_IV12_TAG16_NO_KDF;
var d3 : AESEncryption.AES_GCM := AESEncryption.AES_GCM.AES_GCM(keyLength:=(32 as AESEncryption.KeyLength),tagLength:=(16 as AESEncryption.TagLength),ivLength:=(12 as AESEncryption.IVLength));
var d4 : MaterialProviders.AlgorithmSuites.KeyDerivationAlgorithm := MaterialProviders.AlgorithmSuites.DerivationAlgorithm.IDENTITY;
expect (true && d4.HKDF? ==> d4.inputKeyLength == d4.outputKeyLength && (d4.hmac == HMAC.Digests.SHA_512 ==> d4.inputKeyLength == 32)) && !d4.None?, "Test does not meet type constraints and should be removed";
...
expect (true && d5.HKDF? ==> d5.hmac.SHA_512? && d5.saltLength == 32 && d5.inputKeyLength == 32 && d5.outputKeyLength == 32) && !d5.IDENTITY?, "Test does not meet type constraints and should be removed";
var d6 : MaterialProviders.AlgorithmSuites.SignatureAlgorithm := MaterialProviders.AlgorithmSuites.SignatureAlgorithm.None;
var d7 : MaterialProviders.AlgorithmSuites.AlgorithmSuite := MaterialProviders.AlgorithmSuites.AlgorithmSuiteInfo.AlgorithmSuiteInfo(messageVersion:=62,id:=d2,encrypt:=d3,kdf:=d4,commitment:=d5,signature:=d6);
expect (d7.kdf.HKDF? ==> d7.kdf.outputKeyLength == d7.encrypt.keyLength) && (d7.signature.ECDSA? ==> d7.kdf.HKDF?) && (d7.commitment.HKDF? ==> d7.commitment.saltLength == 32 && d7.commitment == d7.kdf) && (d7.kdf.HKDF? && d7.commitment.None? ==> d7.kdf.saltLength == 0) && (d7.id == Aws.Crypto.AlgorithmSuiteId.ALG_AES_128_GCM_IV12_TAG16_NO_KDF ==> d7.messageVersion == 1 && d7.encrypt.keyLength == 16 && d7.kdf.IDENTITY? && d7.signature.None? && d7.commitment.None?) && (d7.id == Aws.Crypto.AlgorithmSuiteId.ALG_AES_192_GCM_IV12_TAG16_NO_KDF ==> d7.messageVersion == 1 && d7.encrypt.keyLength == 24 && d7.kdf.IDENTITY? && d7.signature.None? && d7.commitment.None?) && (d7.id == Aws.Crypto.AlgorithmSuiteId.ALG_AES_256_GCM_IV12_TAG16_NO_KDF ==> d7.messageVersion == 1 && d7.encrypt.keyLength == 32 && d7.kdf.IDENTITY? && d7.signature.None? && d7.commitment.None?) && (d7.id == Aws.Crypto.AlgorithmSuiteId.ALG_AES_128_GCM_IV12_TAG16_HKDF_SHA256 ==> d7.messageVersion == 1 && d7.encrypt.keyLength == 16 && d7.kdf.HKDF? && d7.kdf.hmac == HMAC.Digests.SHA_256 && d7.signature.None? && d7.commitment.None?) && (d7.id == Aws.Crypto.AlgorithmSuiteId.ALG_AES_192_GCM_IV12_TAG16_HKDF_SHA256 ==> d7.messageVersion == 1 && d7.encrypt.keyLength == 24 && d7.kdf.HKDF? && d7.kdf.hmac == HMAC.Digests.SHA_256 && d7.signature.None? && d7.commitment.None?) && (d7.id == Aws.Crypto.AlgorithmSuiteId.ALG_AES_256_GCM_IV12_TAG16_HKDF_SHA256 ==> d7.messageVersion == 1 && d7.encrypt.keyLength == 32 && d7.kdf.HKDF? && d7.kdf.hmac == HMAC.Digests.SHA_256 && d7.signature.None? && d7.commitment.None?) && (d7.id == Aws.Crypto.AlgorithmSuiteId.ALG_AES_128_GCM_IV12_TAG16_HKDF_SHA256_ECDSA_P256 ==> d7.messageVersion == 1 && d7.encrypt.keyLength == 16 && d7.kdf.HKDF? && d7.kdf.hmac == HMAC.Digests.SHA_256 && d7.signature.ECDSA? && d7.signature.curve == Signature.ECDSAParams.ECDSA_P256 && d7.commitment.None?) && (d7.id == Aws.Crypto.AlgorithmSuiteId.ALG_AES_192_GCM_IV12_TAG16_HKDF_SHA384_ECDSA_P384 ==> d7.messageVersion == 1 && d7.encrypt.keyLength == 24 && d7.kdf.HKDF? && d7.kdf.hmac == HMAC.Digests.SHA_384 && d7.signature.ECDSA? && d7.signature.curve == Signature.ECDSAParams.ECDSA_P384 && d7.commitment.None?) && (d7.id == Aws.Crypto.AlgorithmSuiteId.ALG_AES_256_GCM_IV12_TAG16_HKDF_SHA384_ECDSA_P384 ==> d7.messageVersion == 1 && d7.encrypt.keyLength == 32 && d7.kdf.HKDF? && d7.kdf.hmac == HMAC.Digests.SHA_384 && d7.signature.ECDSA? && d7.signature.curve == Signature.ECDSAParams.ECDSA_P384 && d7.commitment.None?) && (d7.id == Aws.Crypto.AlgorithmSuiteId.ALG_AES_256_GCM_HKDF_SHA512_COMMIT_KEY ==> d7.messageVersion == 2 && d7.encrypt.keyLength == 32 && d7.kdf.HKDF? && d7.kdf.hmac == HMAC.Digests.SHA_512 && d7.signature.None? && d7.commitment.HKDF?) && (d7.id == Aws.Crypto.AlgorithmSuiteId.ALG_AES_256_GCM_HKDF_SHA512_COMMIT_KEY_ECDSA_P384 ==> d7.messageVersion == 2 && d7.encrypt.keyLength == 32 && d7.kdf.HKDF? && d7.kdf.hmac == HMAC.Digests.SHA_512 && d7.signature.ECDSA? && d7.signature.curve == Signature.ECDSAParams.ECDSA_P384 && d7.commitment.HKDF?), "Test does not meet type constraints and should be removed";
var r0 := HeaderAuth.ReadHeaderAuthTagV2(d1, d7);
expect r0.Success? ==> |r0.value.data.headerIv| == d7.encrypt.ivLength as nat && |r0.value.data.headerAuthTag| == d7.encrypt.tagLength as nat;
}
// Test HeaderAuth.ReadHeaderAuthTag(block#2238582) covers block 2238577
// Test HeaderAuth.ReadHeaderAuthTag(block#2238582) covers block 2238578
// Test HeaderAuth.ReadHeaderAuthTag(block#2238582) covers block 2238582
// Extracting the test for HeaderAuth.ReadHeaderAuthTag(block#2238582) from the counterexample...
method {:test} test11() {
var d0 : seq<StandardLibrary.UInt.uint8> := [(0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8)];
...
// Test HeaderAuth.ReadHeaderAuthTag(block#2238581) covers block 2238577
// Test HeaderAuth.ReadHeaderAuthTag(block#2238581) covers block 2238579
// Test HeaderAuth.ReadHeaderAuthTag(block#2238581) covers block 2238581
// Extracting the test for HeaderAuth.ReadHeaderAuthTag(block#2238581) from the counterexample...
method {:test} test12() {
var d0 : seq<StandardLibrary.UInt.uint8> := [];
var d1 : SerializeFunctions.ReadableBuffer := SerializeFunctions.ReadableBuffer.ReadableBuffer(bytes:=d0,start:=(1236 as nat));
var d2 : Aws.Crypto.AlgorithmSuiteId := Crypto.AlgorithmSuiteId.ALG_AES_128_GCM_IV12_TAG16_NO_KDF;
...
expect (true && d5.HKDF? ==> d5.hmac.SHA_512? && d5.saltLength == 32 && d5.inputKeyLength == 32 && d5.outputKeyLength == 32) && !d5.IDENTITY?, "Test does not meet type constraints and should be removed";
var d6 : MaterialProviders.AlgorithmSuites.SignatureAlgorithm := MaterialProviders.AlgorithmSuites.SignatureAlgorithm.None;
var d7 : MaterialProviders.AlgorithmSuites.AlgorithmSuite := MaterialProviders.AlgorithmSuites.AlgorithmSuiteInfo.AlgorithmSuiteInfo(messageVersion:=60,id:=d2,encrypt:=d3,kdf:=d4,commitment:=d5,signature:=d6);
expect (d7.kdf.HKDF? ==> d7.kdf.outputKeyLength == d7.encrypt.keyLength) && (d7.signature.ECDSA? ==> d7.kdf.HKDF?) && (d7.commitment.HKDF? ==> d7.commitment.saltLength == 32 && d7.commitment == d7.kdf) && (d7.kdf.HKDF? && d7.commitment.None? ==> d7.kdf.saltLength == 0) && (d7.id == Aws.Crypto.AlgorithmSuiteId.ALG_AES_128_GCM_IV12_TAG16_NO_KDF ==> d7.messageVersion == 1 && d7.encrypt.keyLength == 16 && d7.kdf.IDENTITY? && d7.signature.None? && d7.commitment.None?) && (d7.id == Aws.Crypto.AlgorithmSuiteId.ALG_AES_192_GCM_IV12_TAG16_NO_KDF ==> d7.messageVersion == 1 && d7.encrypt.keyLength == 24 && d7.kdf.IDENTITY? && d7.signature.None? && d7.commitment.None?) && (d7.id == Aws.Crypto.AlgorithmSuiteId.ALG_AES_256_GCM_IV12_TAG16_NO_KDF ==> d7.messageVersion == 1 && d7.encrypt.keyLength == 32 && d7.kdf.IDENTITY? && d7.signature.None? && d7.commitment.None?) && (d7.id == Aws.Crypto.AlgorithmSuiteId.ALG_AES_128_GCM_IV12_TAG16_HKDF_SHA256 ==> d7.messageVersion == 1 && d7.encrypt.keyLength == 16 && d7.kdf.HKDF? && d7.kdf.hmac == HMAC.Digests.SHA_256 && d7.signature.None? && d7.commitment.None?) && (d7.id == Aws.Crypto.AlgorithmSuiteId.ALG_AES_192_GCM_IV12_TAG16_HKDF_SHA256 ==> d7.messageVersion == 1 && d7.encrypt.keyLength == 24 && d7.kdf.HKDF? && d7.kdf.hmac == HMAC.Digests.SHA_256 && d7.signature.None? && d7.commitment.None?) && (d7.id == Aws.Crypto.AlgorithmSuiteId.ALG_AES_256_GCM_IV12_TAG16_HKDF_SHA256 ==> d7.messageVersion == 1 && d7.encrypt.keyLength == 32 && d7.kdf.HKDF? && d7.kdf.hmac == HMAC.Digests.SHA_256 && d7.signature.None? && d7.commitment.None?) && (d7.id == Aws.Crypto.AlgorithmSuiteId.ALG_AES_128_GCM_IV12_TAG16_HKDF_SHA256_ECDSA_P256 ==> d7.messageVersion == 1 && d7.encrypt.keyLength == 16 && d7.kdf.HKDF? && d7.kdf.hmac == HMAC.Digests.SHA_256 && d7.signature.ECDSA? && d7.signature.curve == Signature.ECDSAParams.ECDSA_P256 && d7.commitment.None?) && (d7.id == Aws.Crypto.AlgorithmSuiteId.ALG_AES_192_GCM_IV12_TAG16_HKDF_SHA384_ECDSA_P384 ==> d7.messageVersion == 1 && d7.encrypt.keyLength == 24 && d7.kdf.HKDF? && d7.kdf.hmac == HMAC.Digests.SHA_384 && d7.signature.ECDSA? && d7.signature.curve == Signature.ECDSAParams.ECDSA_P384 && d7.commitment.None?) && (d7.id == Aws.Crypto.AlgorithmSuiteId.ALG_AES_256_GCM_IV12_TAG16_HKDF_SHA384_ECDSA_P384 ==> d7.messageVersion == 1 && d7.encrypt.keyLength == 32 && d7.kdf.HKDF? && d7.kdf.hmac == HMAC.Digests.SHA_384 && d7.signature.ECDSA? && d7.signature.curve == Signature.ECDSAParams.ECDSA_P384 && d7.commitment.None?) && (d7.id == Aws.Crypto.AlgorithmSuiteId.ALG_AES_256_GCM_HKDF_SHA512_COMMIT_KEY ==> d7.messageVersion == 2 && d7.encrypt.keyLength == 32 && d7.kdf.HKDF? && d7.kdf.hmac == HMAC.Digests.SHA_512 && d7.signature.None? && d7.commitment.HKDF?) && (d7.id == Aws.Crypto.AlgorithmSuiteId.ALG_AES_256_GCM_HKDF_SHA512_COMMIT_KEY_ECDSA_P384 ==> d7.messageVersion == 2 && d7.encrypt.keyLength == 32 && d7.kdf.HKDF? && d7.kdf.hmac == HMAC.Digests.SHA_512 && d7.signature.ECDSA? && d7.signature.curve == Signature.ECDSAParams.ECDSA_P384 && d7.commitment.HKDF?), "Test does not meet type constraints and should be removed";
var r0 := HeaderAuth.ReadHeaderAuthTag(d1, d7);
expect r0.Success? ==> |r0.value.data.headerIv| == d7.encrypt.ivLength as nat && |r0.value.data.headerAuthTag| == d7.encrypt.tagLength as nat;
}
// Test HeaderAuth.ReadHeaderAuthTag(block#2238580) covers block 2238577
// Test HeaderAuth.ReadHeaderAuthTag(block#2238580) covers block 2238579
// Test HeaderAuth.ReadHeaderAuthTag(block#2238580) covers block 2238580
// Extracting the test for HeaderAuth.ReadHeaderAuthTag(block#2238580) from the counterexample...
method {:test} test13() {
var d0 : seq<StandardLibrary.UInt.uint8> := [(0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8), (0 as StandardLibrary.UInt.uint8)];

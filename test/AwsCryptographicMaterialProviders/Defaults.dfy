...
module srcAwsCryptographicMaterialProvidersDefaultsdfyUnitTests {
import Defaults
import UTF8
...
// Test Defaults.GetAlgorithmSuiteForCommitmentPolicy(block#1356795) covers block 1356792
// Test Defaults.GetAlgorithmSuiteForCommitmentPolicy(block#1356795) covers block 1356793
// Test Defaults.GetAlgorithmSuiteForCommitmentPolicy(block#1356795) covers block 1356795
// Extracting the test for Defaults.GetAlgorithmSuiteForCommitmentPolicy(block#1356795) from the counterexample...
method {:test} test0() {
...
// Test Defaults.GetAlgorithmSuiteForCommitmentPolicy(block#1356794) covers block 1356792
// Test Defaults.GetAlgorithmSuiteForCommitmentPolicy(block#1356794) covers block 1356794
// Extracting the test for Defaults.GetAlgorithmSuiteForCommitmentPolicy(block#1356794) from the counterexample...
method {:test} test1() {

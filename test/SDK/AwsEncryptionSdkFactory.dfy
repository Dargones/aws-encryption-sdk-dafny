...
// Test AwsEncryptionSdkFactory.AwsEncryptionSdkFactory.CreateDefaultAwsEncryptionSdk(block#2769686) covers block 2769686
// Extracting the test for AwsEncryptionSdkFactory.AwsEncryptionSdkFactory.CreateDefaultAwsEncryptionSdk(block#2769686) from the counterexample...
method {:test} test0() {
var v0 := getFreshAwsEncryptionSdkFactoryAwsEncryptionSdkFactory();
var r0 := v0.CreateDefaultAwsEncryptionSdk();
expect r0.Success?;
}
// Test AwsEncryptionSdkFactory.AwsEncryptionSdkFactory.CreateAwsEncryptionSdk(block#2774166) covers block 2774161
// Test AwsEncryptionSdkFactory.AwsEncryptionSdkFactory.CreateAwsEncryptionSdk(block#2774166) covers block 2774162
// Test AwsEncryptionSdkFactory.AwsEncryptionSdkFactory.CreateAwsEncryptionSdk(block#2774166) covers block 2774164
// Test AwsEncryptionSdkFactory.AwsEncryptionSdkFactory.CreateAwsEncryptionSdk(block#2774166) covers block 2774166
// Extracting the test for AwsEncryptionSdkFactory.AwsEncryptionSdkFactory.CreateAwsEncryptionSdk(block#2774166) from the counterexample...
method {:test} test1() {
var v0 := getFreshAwsEncryptionSdkFactoryAwsEncryptionSdkFactory();
var d0 : Wrappers.Option<Aws.Crypto.CommitmentPolicy> := Wrappers.Option<Aws.Crypto.CommitmentPolicy>.None;
var d1 : Wrappers.Option<StandardLibrary.UInt.int64> := Wrappers.Option<StandardLibrary.UInt.int64>.Some(value:=(1 as StandardLibrary.UInt.int64));
...
expect d2.maxEncryptedDataKeys.Some? && d2.maxEncryptedDataKeys.value <= 0 ==> r0.Failure?;
expect d2.maxEncryptedDataKeys.None? || (d2.maxEncryptedDataKeys.Some? && d2.maxEncryptedDataKeys.value > 0) ==> r0.Success?;
}
// Test AwsEncryptionSdkFactory.AwsEncryptionSdkFactory.CreateAwsEncryptionSdk(block#2774165) covers block 2774161
// Test AwsEncryptionSdkFactory.AwsEncryptionSdkFactory.CreateAwsEncryptionSdk(block#2774165) covers block 2774162
// Test AwsEncryptionSdkFactory.AwsEncryptionSdkFactory.CreateAwsEncryptionSdk(block#2774165) covers block 2774164
// Test AwsEncryptionSdkFactory.AwsEncryptionSdkFactory.CreateAwsEncryptionSdk(block#2774165) covers block 2774165
// Extracting the test for AwsEncryptionSdkFactory.AwsEncryptionSdkFactory.CreateAwsEncryptionSdk(block#2774165) from the counterexample...
method {:test} test2() {
var v0 := getFreshAwsEncryptionSdkFactoryAwsEncryptionSdkFactory();
var d0 : Wrappers.Option<Aws.Crypto.CommitmentPolicy> := Wrappers.Option<Crypto.CommitmentPolicy>.None;
var d1 : Wrappers.Option<StandardLibrary.UInt.int64> := Wrappers.Option<StandardLibrary.UInt.int64>.Some(value:=(-9223372036854774572 as StandardLibrary.UInt.int64));
var d2 : Aws.Esdk.AwsEncryptionSdkConfig := Aws.Esdk.AwsEncryptionSdkConfig.AwsEncryptionSdkConfig(commitmentPolicy:=d0,maxEncryptedDataKeys:=d1);
var r0 := v0.CreateAwsEncryptionSdk(d2);
expect d2.maxEncryptedDataKeys.Some? && d2.maxEncryptedDataKeys.value <= 0 ==> r0.Failure?;
expect d2.maxEncryptedDataKeys.None? || (d2.maxEncryptedDataKeys.Some? && d2.maxEncryptedDataKeys.value > 0) ==> r0.Success?;
}
// Test AwsEncryptionSdkFactory.AwsEncryptionSdkFactory.CreateAwsEncryptionSdk(block#2774163) covers block 2774161
// Test AwsEncryptionSdkFactory.AwsEncryptionSdkFactory.CreateAwsEncryptionSdk(block#2774163) covers block 2774163
// Extracting the test for AwsEncryptionSdkFactory.AwsEncryptionSdkFactory.CreateAwsEncryptionSdk(block#2774163) from the counterexample...
method {:test} test3() {
var v0 := getFreshAwsEncryptionSdkFactoryAwsEncryptionSdkFactory();
var d0 : Wrappers.Option<Aws.Crypto.CommitmentPolicy> := Wrappers.Option<Crypto.CommitmentPolicy>.None;

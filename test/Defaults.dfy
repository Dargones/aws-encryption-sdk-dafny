...
// Test Defaults.GetAlgorithmSuiteForCommitmentPolicy(block#1367582) covers block 1367579
// Test Defaults.GetAlgorithmSuiteForCommitmentPolicy(block#1367582) covers block 1367580
// Test Defaults.GetAlgorithmSuiteForCommitmentPolicy(block#1367582) covers block 1367582
// Extracting the test for Defaults.GetAlgorithmSuiteForCommitmentPolicy(block#1367582) from the counterexample...
method {:test} test0() {
...
// Test Defaults.GetAlgorithmSuiteForCommitmentPolicy(block#1367581) covers block 1367579
// Test Defaults.GetAlgorithmSuiteForCommitmentPolicy(block#1367581) covers block 1367581
// Extracting the test for Defaults.GetAlgorithmSuiteForCommitmentPolicy(block#1367581) from the counterexample...
method {:test} test1() {
...
// Procedure Impl$$Defaults.__default.GetAlgorithmSuiteForCommitmentPolicy (4 blocks) is completely covered by 2 (failed to extract 0) tests generated using 2 SMT queries (failed 0 queries)

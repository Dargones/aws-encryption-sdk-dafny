...
// Test MaterialProviders.ClientFactory.AwsCryptographicMaterialProvidersFactory.CreateDefaultAwsCryptographicMaterialProviders(block#1665680) covers block 1665680
// Extracting the test for MaterialProviders.ClientFactory.AwsCryptographicMaterialProvidersFactory.CreateDefaultAwsCryptographicMaterialProviders(block#1665680) from the counterexample...
method {:test} test0() {
...
// Procedure Impl$$MaterialProviders_mClientFactory.AwsCryptographicMaterialProvidersFactory.CreateDefaultAwsCryptographicMaterialProviders (1 blocks) is completely covered by 1 (failed to extract 0) tests generated using 1 SMT queries (failed 0 queries)
